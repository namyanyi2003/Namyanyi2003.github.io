...
Without Volume VIII, the system can describe conflict and burden.  
With Volume VIII, the system can explain why advice fails, why direction triggers resistance, and why externally clear instruction may still be mechanically impossible to carry out.

## Keywords

symbolic mechanics, instruction resistance, anti-compliance mechanics, guidance failure, symbolic rejection, directive pressure, counter-processing, deterministic symbolic system, symbolic-computational theory, resistance mechanics, non-executable instruction, downstream architecture, relational dynamics
